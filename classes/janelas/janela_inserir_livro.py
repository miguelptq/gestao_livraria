...
class JanelaInserirLivro:
    def __init__(self, user):
        ...
        self.isbn_lbl = customtkinter.CTkLabel(self.janela_inserir, text = 'ISBN:', font=customtkinter.CTkFont(size=20, weight='bold'))
        self.isbn_lbl.grid(row = 1, column = 0, sticky = 'W', pady = 20)

        self.isbn_lbl_entry = customtkinter.CTkEntry(self.janela_inserir, font=customtkinter.CTkFont(size=20, weight='bold'))
        ...
        self.add_autor_btn = customtkinter.CTkButton(self.janela_inserir, text="+",font=customtkinter.CTkFont(size=14, weight='normal'), command = self.add_autor)
        self.add_autor_btn.grid(row=5, column=2, padx=(10, 20), pady=10)


    def guardar_livro(self, autores):
        isbn = self.isbn_lbl_entry.get()
        title = self.desc_livro_entry.get()
    ...
    def add_autor(self):
        ...
        new_autor_entry = Entry(self.janela_inserir, font=customtkinter.CTkFont(size=20, weight='normal'))
